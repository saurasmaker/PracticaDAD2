...
public class User {
	...
	//Static Atributes
	public static String USER_PARAM = "USER_PARAM", USER_USERNAME_PARAM = "USER_USERNAME_PARAM", USER_EMAIL_PARAM = "USER_EMAIL_PARAM",  
			USER_ID_PARAM = "USER_ID_PARAM", USER_BIOGRAPHY_PARAM = "USER_BIOGRAPHY_PARAM", USER_ADDRESS_PARAM = "USER_ADDRESS_PARAM",
			USER_REPEAT_PASSWORD_PARAM = "USER_REPEAT_PASSWORD_PARAM", USER_PASSWORD_PARAM = "USER_PASSWORD_PARAM";
